...
<body>
    <div class="admin-container">
        ...
        <div class="main-content">   
            ...
            <h3 class="h3">Commandes en attentes pour GP: <?php echo($_SESSION['user_name']); ?></h3>
                <table>
                    <thead>
                        <tr>
                            <th>id</th>
                ...
                $sql_count = "SELECT COUNT(*) as total_commandes FROM commandes_produits WHERE status='en attente' AND gp_id= ?";
                ...
                $sql = "SELECT id, user_id, nom_produit, quantite, destination, status, date_commande FROM commandes_produits WHERE status='en attente' AND gp_id=? ORDER BY id DESC limit $debut,$nbr"; // Remplacez 'commandes' par le nom de votre table
