...
<body>
    <div class="admin-container">
        ...
        <div class="main-content">   
            ...
            <button class="btn"><a href="page_admin.php">Gestion des Admin</a></button>
                <table>
                    <thead>
                        <tr>
                ...
                $sql = "SELECT id, user, nom, telephone, adresse, date_inscription FROM users WHERE role='utilisateur' ORDER BY id DESC limit $debut,$nbr"; // Remplacez 'commandes' par le nom de votre table
                ...
                /*if(count($row)==0){
                    ...
                    while ($row = $suivre->fetch(PDO::FETCH_ASSOC)) {
                        ...
                        echo '<td>' .
                        '<form action="supp_users.php" method="POST">
