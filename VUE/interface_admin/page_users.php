    ...
    <div class="admin-container">
        ...
        <div class="main-content">   
            ...
            <button class="btn"><a href="page_admin.php">Gestion des Admin</a></button>
                ...
                $sql = "SELECT id, user, nom, telephone, adresse, date_inscription FROM users WHERE role='utilisateur' limit $debut,$nbr"; // Remplacez 'commandes' par le nom de votre table
