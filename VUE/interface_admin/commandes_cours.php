    ...
    <div class="admin-container">
        ...
        <div class="main-content">   
            ...
            <button class="btn"><a href="commandes_livrees.php">Comnnades livrées</a></button>
                ...
                $sql = "SELECT id, user_id, nom_produit, quantite, destination, date_commande FROM commandes_produits WHERE status='en cours' limit $debut,$nbr"; // Remplacez 'commandes' par le nom de votre table
