...
<body>
    <div class="admin-container">
        ...
        <div class="main-content">   
            ...
            <h3 class="h3">commandes en cours</h3>
            <button class="btn"><a href="commandes_attentes.php">Commandes en attentes</a></button>
            <button class="btn"><a href="commandes_livrees.php">Comnnades livrées</a></button>
                ...
                $sql_count = "SELECT COUNT(*) as total_commandes FROM commandes_produits WHERE status='en cours'";
                ...
                $sql = "SELECT id, user_id, nom_produit, quantite, destination, date_commande FROM commandes_produits WHERE status='en cours' ORDER BY id DESC limit $debut,$nbr"; // Remplacez 'commandes' par le nom de votre table
